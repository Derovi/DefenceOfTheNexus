...
class SmartSerializer {
  public:
    ...
    static QJsonObject gamePartWorldSerializer(const std::shared_ptr<const core::GameWorld>& beforeChanges,
                                        const std::shared_ptr<const core::GameWorld>& afterChanges,
                                        const utils::KeyManager& keyManager);

    static QJsonObject objectPartSerializer(const std::shared_ptr<const core::Object>& beforeChanges,
                                     const std::shared_ptr<const core::Object>& afterChanges,
                                     const utils::KeyManager& keyManager);

    static QJsonObject resourcePartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject damagingPartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject damageablePartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject movingPartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject miningPartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject wallPartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject costPartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                         const std::shared_ptr<const core::Attribute>& afterChanges,
                                         const utils::KeyManager& keyManager);

    static QJsonObject builderPartSerializer(const std::shared_ptr<const core::Attribute>& beforeChanges,
                                     const std::shared_ptr<const core::Attribute>& afterChanges,
                                     const utils::KeyManager& keyManager);
